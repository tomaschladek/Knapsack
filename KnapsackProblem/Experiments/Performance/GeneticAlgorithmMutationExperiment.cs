...
{
    public class GeneticAlgorithmMutationExperiment : AbstractExperiment<ExecutionResultDto>
    {
        public override string Id => "GA_Duration_Mutation";
